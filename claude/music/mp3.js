...
let track_list = [
	{
		...
		album: "Modern Vampires of the City", // name of album
		genre: "Indie Rock",
		year: "2013", // year song was released
		image: "/claude/music/mvotc.jpeg", // album cover path
		path: "/claude/music/step.mp3", // mp3 audio path
	},
	{
		name: "Reflektor",
		artist: "Arcade Fire",
		...
		genre: "Indie Rock",
		year: "2013",
		image: "/claude/music/reflektor.jpg",
		path: "/claude/music/reflektor.mp3",
	},
	{
		name: "Kettering",
		artist: "The Antlers",
		...
		genre: "Indie Rock",
		year: "2009",
		image: "/claude/music/hospice.jpg",
		path: "/claude/music/kettering.mp3",
	},
];
